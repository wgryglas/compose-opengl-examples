...
import vtkrendering.RenderSurface
import vtkrendering.VtkRenderCommands
...
fun main() {
    ...
    val vtk = VtkRenderCommands(rSurf)
    ...
    fun render() {
        ...
        vtk.invoke(curr.toFloat() / 1_000)

//        surface.canvas.clear(Color(222, 226, 230, 255).toArgb())
